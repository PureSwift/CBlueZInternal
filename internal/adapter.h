...
typedef void (*adapter_cb) (struct btd_adapter *adapter, void* user_data);
...
void adapter_foreach(adapter_cb func, void* user_data);
...
void adapter_add_profile(struct btd_adapter *adapter, void* p);
void adapter_remove_profile(struct btd_adapter *adapter, void* p);
...
int btd_adapter_check_oob_handler(struct btd_adapter *adapter);
